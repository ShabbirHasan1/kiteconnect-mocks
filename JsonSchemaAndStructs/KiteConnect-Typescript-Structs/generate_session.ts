// To parse this data:
//
//   import { Convert, GenerateSession } from "./file";
//
//   const generateSession = Convert.toGenerateSession(json);
//
...
export class Convert {
    public static toGenerateSession(json: string): GenerateSession {
        return cast(JSON.parse(json), r("GenerateSession"));
    }

    public static generateSessionToJson(value: GenerateSession): string {
        return JSON.stringify(uncast(value, r("GenerateSession")), null, 2);
    }
}
...
const typeMap: any = {
    ...
    "Data": o([
        ...
        { json: "public_token", js: "publicToken", typ: u(undefined, "") },
        { json: "refresh_token", js: "refreshToken", typ: u(undefined, "") },
        { json: "silo", js: "silo", typ: u(undefined, "") },
