...
export interface InstrumentsAll {
    exchange?:        Exchange;
...
export class Convert {
    public static toInstrumentsAll(json: string): InstrumentsAll[] {
        return cast(JSON.parse(json), a(r("InstrumentsAll")));
    }

    public static instrumentsAllToJson(value: InstrumentsAll[]): string {
